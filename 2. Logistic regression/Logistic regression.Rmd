...
packages <- c("gapminder", "dplyr", "ggplot2", "gridExtra", "tidymodels", "titanic", "mice", "visdat", "naniar")
...
Looking at our data, some if seems to stick out. PassengerId is not likely to be useful, so I think we can drop that. However, the Name column also contains the title. Let's explore that a bit.
